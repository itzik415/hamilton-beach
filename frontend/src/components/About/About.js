    ...
    return (
        <div className="about">
            ...
            <div className="about-main">
                ...
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.shaoulian.co.il" target="_blank"> shaoulian.co.il</a> אתר החברה הרשמי.</p>
                <p className="about-main-paragraph">חברת שאוליאן נציגה בלעדית של מגוון רחב של מותגים:</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.hamiltonbeach.co.il" target="_blank"> hamiltonbeach.co.il</a> מוצרי חשמל לבית ולמטבח מבית, Hamilton Beach.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.lofra.co.il" target="_blank"> lofra.co.il </a>תנורים משולבים מקצועיים תוצרת איטליה, LOFRA.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.sol.co.il" target="_blank">sol.co.il</a> כיריים קרמיות וגז ותנורי בילד אין תוצרת איטליה, SOL.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.turboair.co.il" target="_blank">turboair.co.il</a> קולטי אדים מיוחדים במינם תוצרת איטליה, TURBOAIR.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.valera.co.il" target="_blank">Valera.co.il </a> טיפוח מקצועי וציוד לבתי מלון תוצרת שוויץ, VALERA.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.ufesa.co.il" target="_blank">ufesa.co.il</a> מוצרי חשמל לבית ולמטבח מבית, UFESA.</p>
                <p className="about-main-paragraph">- <a id="website-link" rel="noopener noreferrer" href="http://www.boohr.co.il" target="_blank">Boohr.co.il</a> בלנדרים מקצועיים ומסחטות לפירות וירקות בריאותיים, Boohr.</p>
